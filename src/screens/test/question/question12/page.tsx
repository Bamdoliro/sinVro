...
import { useCTAButton } from './question12.hooks';
...
const Question12Page = () => {
  ...
  return (
    <>
      ...
      <StyledQuestion12Page>
        <CustomText fontType="H4" color={color.white100}>
          Q12. 어떤 일이나 상황 때문에 두려움을 느낀 적이 있다.
        </CustomText>
        <ButtonContainer>
          {[1, 2, 3, 4, 5].map((value) => (
            <StyledButton
...
const StyledQuestion12Page = styled.View`
