...
const Question14Page = () => {
  ...
  return (
    <>
      ...
      <StyledQuestion14Page>
        <CustomText fontType="H4" color={color.white100}>
          Q14. 세상에 홀로 있는 듯한 외로움을 느꼈다.
        </CustomText>
        <ButtonContainer>
          {[1, 2, 3, 4, 5].map((value) => (
            <StyledButton
...
export default Question14Page;

const StyledQuestion14Page = styled.View`
