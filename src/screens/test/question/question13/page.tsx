...
export default Question13Page;

const StyledQuestion13Page = styled.View`
...
const ButtonContainer = styled.View`
  ...
  margin-top: ${calculateHeight(295)}px;
