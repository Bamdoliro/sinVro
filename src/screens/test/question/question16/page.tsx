...
const Question16Page = () => {
  ...
  return (
    <>
      ...
      <StyledQuestion16Page>
        <CustomText fontType="H4" color={color.white100}>
          Q16. 사람들이 나에게 차갑게 대하는 것 같았다.
        </CustomText>
        <ButtonContainer>
          {[1, 2, 3, 4, 5].map((value) => (
            <StyledButton
...
export default Question16Page;

const StyledQuestion16Page = styled.View`
